...
trait ScheduledExecutorService extends JScheduledExecutorService with ExecutorService {
  ...
  @deprecated("Use scheduleWithFixedDelay(FiniteDuration, FiniteDuration)", "0.3.2")
  ...
  @deprecated("Use scheduleAtFixedRate(FiniteDuration, FiniteDuration)", "0.3.2")
  ...
  @deprecated("Use schedule(FiniteDuration)", "0.3.2")
